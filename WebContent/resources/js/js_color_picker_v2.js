...
************************************************************************************************************/	
	...
	function closeColorPicker()
	{
		...
		if(removeobj!=null){
			removeobj.removeChild(color_picker_div);
		}
	...
	function showColorPicker(inputObj,formField,panelobj)
	{
	  removeobj=panelobj;	
		//if(!color_picker_div){
			...
			panelobj.appendChild(color_picker_div);
	...
	var chckrmv="";
	function closecolor_picker_div(panelobj){
		//alert(chckrmv);
		if(color_picker_div&&chckrmv==''){
			panelobj.removeChild(color_picker_div);
			chckrmv="";
		}
	}
