...
/**
 * Servlet implementation class ODCallback
 */
public class ODCallback extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(error != null && !error.isEmpty()) {
				...
				response.getWriter().append("OneDrive account is not authenticated. Because, "+errStr+" You can close this tab now.");
				response.sendError(response.getStatus(), errStr);
			...
			writer.close();
			response.getWriter().append("OneDrive account is authenticated successfully. You can close this tab now.");
			}catch (Exception e) {
