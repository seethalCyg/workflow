...
/**
 * Servlet implementation class GDCallback
 */
public class GDCallback extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(error != null && !error.isEmpty()) {
				...
				response.getWriter().append("Google Drive account is not authenticated. Because, "+errStr+" You can close this tab now.");
			...
			writer.close();
			response.getWriter().append("Google Drive account is authenticated successfully. You can close this tab now.");
			}catch (Exception e) {
