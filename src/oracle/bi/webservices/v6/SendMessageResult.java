...
public class SendMessageResult  implements java.io.Serializable {
    ...
    /**
     * Gets the status value for this SendMessageResult.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this SendMessageResult.
     * 
     * @param status
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">sendMessageResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("status");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "status"));
