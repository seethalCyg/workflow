...
public class GetSubItemsFilter  implements java.io.Serializable {
    private oracle.bi.webservices.v6.NameValuePair[] itemInfoFilters;
    ...
    public GetSubItemsFilter(
           oracle.bi.webservices.v6.NameValuePair[] itemInfoFilters,
     ...
     */
    public oracle.bi.webservices.v6.NameValuePair[] getItemInfoFilters() {
        return itemInfoFilters;
    }
     ...
     */
    public void setItemInfoFilters(oracle.bi.webservices.v6.NameValuePair[] itemInfoFilters) {
        this.itemInfoFilters = itemInfoFilters;
    }

    public oracle.bi.webservices.v6.NameValuePair getItemInfoFilters(int i) {
        return this.itemInfoFilters[i];
    }

    public void setItemInfoFilters(int i, oracle.bi.webservices.v6.NameValuePair _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "GetSubItemsFilter"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemInfoFilters");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "itemInfoFilters"));
