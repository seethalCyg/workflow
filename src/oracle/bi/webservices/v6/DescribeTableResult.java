...
public class DescribeTableResult  implements java.io.Serializable {
    private oracle.bi.webservices.v6.SATable table;

    public DescribeTableResult() {
    }

    public DescribeTableResult(
           oracle.bi.webservices.v6.SATable table) {
           this.table = table;
    }
     ...
     * @return table
     */
    public oracle.bi.webservices.v6.SATable getTable() {
        return table;
    }
     ...
     * @param table
     */
    public void setTable(oracle.bi.webservices.v6.SATable table) {
        this.table = table;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">describeTableResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("table");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "table"));
