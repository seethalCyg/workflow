...
public class ForgetAccounts  implements java.io.Serializable {
    ...
    public oracle.bi.webservices.v6.Account getAccount(int i) {
        return this.account[i];
    }

    public void setAccount(int i, oracle.bi.webservices.v6.Account _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">forgetAccounts"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "cleanuplevel"));
