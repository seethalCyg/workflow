...
public class XmlViewServiceLocator extends org.apache.axis.client.Service implements oracle.bi.webservices.v6.XmlViewService {
    ...
    private java.lang.String XmlViewServiceSoap_address = "http://system14:7001/analytics/saw.dll?SoapImpl=xmlViewService";
    ...
    public oracle.bi.webservices.v6.XmlViewServiceSoap getXmlViewServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public oracle.bi.webservices.v6.XmlViewServiceSoap getXmlViewServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            oracle.bi.webservices.v6.XmlViewServiceStub _stub = new oracle.bi.webservices.v6.XmlViewServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (oracle.bi.webservices.v6.XmlViewServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                oracle.bi.webservices.v6.XmlViewServiceStub _stub = new oracle.bi.webservices.v6.XmlViewServiceStub(new java.net.URL(XmlViewServiceSoap_address), this);
                _stub.setPortName(getXmlViewServiceSoapWSDDServiceName());
                return _stub;
            }
        }
