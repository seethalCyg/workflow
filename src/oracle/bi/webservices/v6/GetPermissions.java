...
public class GetPermissions  implements java.io.Serializable {
    private oracle.bi.webservices.v6.ACL[] acls;

    private oracle.bi.webservices.v6.Account account;
    ...
    public GetPermissions(
           oracle.bi.webservices.v6.ACL[] acls,
           oracle.bi.webservices.v6.Account account,
     ...
     * @return acls
     */
    public oracle.bi.webservices.v6.ACL[] getAcls() {
        return acls;
    }
     ...
     * @param acls
     */
    public void setAcls(oracle.bi.webservices.v6.ACL[] acls) {
        this.acls = acls;
    }

    public oracle.bi.webservices.v6.ACL getAcls(int i) {
        return this.acls[i];
    }

    public void setAcls(int i, oracle.bi.webservices.v6.ACL _value) {
        this.acls[i] = _value;
    }
     ...
     * @return account
     */
    public oracle.bi.webservices.v6.Account getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(oracle.bi.webservices.v6.Account account) {
        this.account = account;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">getPermissions"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("acls");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "acls"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "account"));
