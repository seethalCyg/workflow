...
public class SAWSessionServiceLocator extends org.apache.axis.client.Service implements oracle.bi.webservices.v6.SAWSessionService {
    ...
    private java.lang.String SAWSessionServiceSoap_address = "http://system14:7001/analytics/saw.dll?SoapImpl=nQSessionService";
    ...
    public oracle.bi.webservices.v6.SAWSessionServiceSoap getSAWSessionServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public oracle.bi.webservices.v6.SAWSessionServiceSoap getSAWSessionServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            oracle.bi.webservices.v6.SAWSessionServiceStub _stub = new oracle.bi.webservices.v6.SAWSessionServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (oracle.bi.webservices.v6.SAWSessionServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                oracle.bi.webservices.v6.SAWSessionServiceStub _stub = new oracle.bi.webservices.v6.SAWSessionServiceStub(new java.net.URL(SAWSessionServiceSoap_address), this);
                _stub.setPortName(getSAWSessionServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "SAWSessionService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "SAWSessionServiceSoap"));
        }
