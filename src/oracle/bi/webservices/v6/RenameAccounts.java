...
public class RenameAccounts  implements java.io.Serializable {
    private oracle.bi.webservices.v6.Account[] from;

    private oracle.bi.webservices.v6.Account[] to;
    ...
    public RenameAccounts(
           oracle.bi.webservices.v6.Account[] from,
           oracle.bi.webservices.v6.Account[] to,
     ...
     * @return from
     */
    public oracle.bi.webservices.v6.Account[] getFrom() {
        return from;
    }
     ...
     * @param from
     */
    public void setFrom(oracle.bi.webservices.v6.Account[] from) {
        this.from = from;
    }

    public oracle.bi.webservices.v6.Account getFrom(int i) {
        return this.from[i];
    }

    public void setFrom(int i, oracle.bi.webservices.v6.Account _value) {
        this.from[i] = _value;
    }
     ...
     * @return to
     */
    public oracle.bi.webservices.v6.Account[] getTo() {
        return to;
    }
     ...
     * @param to
     */
    public void setTo(oracle.bi.webservices.v6.Account[] to) {
        this.to = to;
    }

    public oracle.bi.webservices.v6.Account getTo(int i) {
        return this.to[i];
    }

    public void setTo(int i, oracle.bi.webservices.v6.Account _value) {
        this.to[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">renameAccounts"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("from");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "from"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "to"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "Account"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
