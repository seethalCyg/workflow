...
public class AddReportToPage  implements java.io.Serializable {
    ...
    private oracle.bi.webservices.v6.ReportHTMLOptions options;
    ...
    public AddReportToPage(
           ...
           oracle.bi.webservices.v6.ReportHTMLOptions options,
     ...
     * @return options
     */
    public oracle.bi.webservices.v6.ReportHTMLOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(oracle.bi.webservices.v6.ReportHTMLOptions options) {
        this.options = options;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">addReportToPage"));
