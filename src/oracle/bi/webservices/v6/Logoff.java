...
public class Logoff  implements java.io.Serializable {
    ...
    /**
     * Gets the sessionID value for this Logoff.
     * 
     * @return sessionID
     */
    ...
    /**
     * Sets the sessionID value for this Logoff.
     * 
     * @param sessionID
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">logoff"));
