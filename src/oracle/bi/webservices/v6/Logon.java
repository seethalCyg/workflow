...
public class Logon  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this Logon.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this Logon.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", ">logon"));
