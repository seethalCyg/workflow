...
public class ReportParams  implements java.io.Serializable {
    ...
    private oracle.bi.webservices.v6.Variable[] variables;

    private oracle.bi.webservices.v6.NameValuePair[] nameValues;

    private oracle.bi.webservices.v6.TemplateInfo[] templateInfos;
    ...
    public ReportParams(
           ...
           oracle.bi.webservices.v6.Variable[] variables,
           oracle.bi.webservices.v6.NameValuePair[] nameValues,
           oracle.bi.webservices.v6.TemplateInfo[] templateInfos,
     ...
     * @return variables
     */
    public oracle.bi.webservices.v6.Variable[] getVariables() {
        return variables;
    }
     ...
     * @param variables
     */
    public void setVariables(oracle.bi.webservices.v6.Variable[] variables) {
        this.variables = variables;
    }

    public oracle.bi.webservices.v6.Variable getVariables(int i) {
        return this.variables[i];
    }

    public void setVariables(int i, oracle.bi.webservices.v6.Variable _value) {
     ...
     * @return nameValues
     */
    public oracle.bi.webservices.v6.NameValuePair[] getNameValues() {
        return nameValues;
    }
     ...
     * @param nameValues
     */
    public void setNameValues(oracle.bi.webservices.v6.NameValuePair[] nameValues) {
        this.nameValues = nameValues;
    }

    public oracle.bi.webservices.v6.NameValuePair getNameValues(int i) {
        return this.nameValues[i];
    }

    public void setNameValues(int i, oracle.bi.webservices.v6.NameValuePair _value) {
     ...
     */
    public oracle.bi.webservices.v6.TemplateInfo[] getTemplateInfos() {
        return templateInfos;
    }
     ...
     * @param templateInfos
     */
    public void setTemplateInfos(oracle.bi.webservices.v6.TemplateInfo[] templateInfos) {
        this.templateInfos = templateInfos;
    }

    public oracle.bi.webservices.v6.TemplateInfo getTemplateInfos(int i) {
        return this.templateInfos[i];
    }

    public void setTemplateInfos(int i, oracle.bi.webservices.v6.TemplateInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "ReportParams"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filterExpressions");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "filterExpressions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "variables"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "Variable"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "nameValues"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "templateInfos"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "TemplateInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v6", "viewName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
